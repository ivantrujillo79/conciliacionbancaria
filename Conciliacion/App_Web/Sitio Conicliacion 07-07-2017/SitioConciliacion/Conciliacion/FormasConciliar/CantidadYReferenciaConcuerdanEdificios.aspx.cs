    ...
    public void Consulta_ConciliarPedidosCantidadReferencia(decimal centavos, short statusConcepto, string campoExterno, string campoInterno)
    {
        ...
        try
        {
            ...
            foreach (ReferenciaNoConciliada rnc in listaReferenciaExternas)
            {
                ...
                listResultado = rnc.ConciliarPedidoCantidadYReferenciaMovExternoEdificios(centavos,
            ...
            //listaReferenciaConciliadaPedido = objApp.Consultas.ConsultaConciliarPedidoCantidadReferencia(corporativo, sucursal, año, mes, folio, centavos, statusConcepto, campoExterno, campoInterno);
