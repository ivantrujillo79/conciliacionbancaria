    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div>
                ...
                <asp:TextBox Width="100px" ID="txtFSuministroInicio" runat="server" Text="" CssClass="calendarTextBox" Enabled="false"></asp:TextBox>
                ...
                <asp:ImageButton runat="Server" ID="imgFSuministroInicio" ImageUrl="~/App_Themes/GasMetropolitano/Imagenes/Calendar_scheduleHS.png" AlternateText="Muestra Calendario" />

                <asp:TextBox Width="100px" ID="txtFSuministroFin" runat="server" Text="" CssClass="calendarTextBox" Enabled="false"></asp:TextBox>
                ...
                <asp:ImageButton runat="Server" ID="imgFSuministroFin" ImageUrl="~/App_Themes/GasMetropolitano/Imagenes/Calendar_scheduleHS.png" AlternateText="Muestra Calendario" />
            ...
            <div>
                <asp:Label ID="Label2" runat="server" Text="Seleccionado:">  </asp:Label><asp:Label ID="txtTotalSeleccionado" runat="server" Text="0.00" BackColor="gray" ForeColor="white" Width="90px" ></asp:Label>
                <asp:Label ID="Label4" runat="server" Text="Abono:">  </asp:Label><asp:Label ID="txtTotalAbono" runat="server" Text="0.00" BackColor="blue" ForeColor="white" Width="90px"></asp:Label>
                <asp:Label ID="Label6" runat="server" Text="Resto">  </asp:Label><asp:Label ID="txtTotalResto" runat="server" Text="0.00" BackColor="purple" ForeColor="white" Width="90px"></asp:Label>
