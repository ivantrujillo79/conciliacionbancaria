...
namespace Conciliacion.RunTime.ReglasDeNegocio
{
    ...
    public class SolicitudConciliacion
    {
        ...
        public SolicitudConciliacion()
        {
            ...
            ListaConfiguraciones.Add(new ConfiguracionTipoFormaConciliacion { TipoConciliacion = 1, FormaConciliacion = 8, FuenteInsumo = "Pedido", CargaFuenteInsumo = true, BuscadoresHabilitados = true, CelulaPorDefecto = 0, TextoInternos = "", ActivaPagare = false });
            ListaConfiguraciones.Add(new ConfiguracionTipoFormaConciliacion { TipoConciliacion = 1, FormaConciliacion = 8, FuenteInsumo = "Archivo", CargaFuenteInsumo = false, BuscadoresHabilitados = true, CelulaPorDefecto = 0, TextoInternos = "", ActivaPagare = false });
            ...
            ListaConfiguraciones.Add(new ConfiguracionTipoFormaConciliacion { TipoConciliacion = 4, FormaConciliacion = 8, FuenteInsumo = "Pedido", CargaFuenteInsumo = true, BuscadoresHabilitados = true, CelulaPorDefecto = 0, TextoInternos = "", ActivaPagare = false });
            ListaConfiguraciones.Add(new ConfiguracionTipoFormaConciliacion { TipoConciliacion = 4, FormaConciliacion = 8, FuenteInsumo = "Archivo", CargaFuenteInsumo = false, BuscadoresHabilitados = true, CelulaPorDefecto = 0, TextoInternos = "", ActivaPagare = false });
            ...
            ListaConfiguraciones.Add(new ConfiguracionTipoFormaConciliacion { TipoConciliacion = 6, FormaConciliacion = 3, FuenteInsumo = "Pedido", CargaFuenteInsumo = true, BuscadoresHabilitados = false, CelulaPorDefecto = 0, TextoInternos = "", ActivaPagare = false });
            ListaConfiguraciones.Add(new ConfiguracionTipoFormaConciliacion { TipoConciliacion = 6, FormaConciliacion = 3, FuenteInsumo = "Archivo", CargaFuenteInsumo = true, BuscadoresHabilitados = false, CelulaPorDefecto = 0, TextoInternos = "", ActivaPagare = false });
            ...
            ListaConfiguraciones.Add(new ConfiguracionTipoFormaConciliacion { TipoConciliacion = 6, FormaConciliacion = 8, FuenteInsumo = "Pedido", CargaFuenteInsumo = true, BuscadoresHabilitados = true, CelulaPorDefecto = 0, TextoInternos = "", ActivaPagare = false });
            ListaConfiguraciones.Add(new ConfiguracionTipoFormaConciliacion { TipoConciliacion = 6, FormaConciliacion = 8, FuenteInsumo = "Archivo", CargaFuenteInsumo = false, BuscadoresHabilitados = true, CelulaPorDefecto = 0, TextoInternos = "", ActivaPagare = false });
