...
namespace Conciliacion.RunTime.DatosSQL
{
    public class ConsultaDatos : Consultas
    {
        ...
        public override string consultaClienteCRM(int cliente)
        {
            ...
            if (DireccionEntrega == null || DireccionEntrega.Nombre == null || DireccionEntrega.Message.Contains("La consulta no produjo resultados con los parametros indicados."))
