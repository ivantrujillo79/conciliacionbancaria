    ...
    public class MensajeImplementacionWeb:IMensajesImplementacion
    {
        ...
        public void MostrarMensaje(string texto)
        {
           Page pagina =(Page)this.contenedor;
            if(mensajesActivos)
                ScriptManager.RegisterStartupScript(pagina, pagina.GetType(), "UpdateMsg", "alertify.alert('Conciliaci&oacute;n bancaria','Error: " + LimpiarTexto(texto) + "', function(){ alertify.error('Error en la solicitud'); });", true);
