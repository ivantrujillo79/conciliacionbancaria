...
alter PROCEDURE [dbo].[spCBConciliarPedidosPorReferenciaPorMovExterno]
...
FROM vwCBPedidosPorAbonar I INNER JOIN Sucursal SI ON SI.Sucursal=I.Sucursal WHERE I.'+Convert(varchar(50),@CampoPedido)+' = '''+@ValorCampoExterno+'''
