ALTER PROCEDURE spCBReporteEstadoDeCuenta          
    @FechaIni DATETIME ,
    @FechaFin DATETIME ,
    @Banco VARCHAR(50) = '' ,
...
AS
	...
	AND (@Banco = 'TODOS' OR @Banco = '' OR b.Descripcion = LTRIM(RTRIM(@Banco)))
	AND (@CuentaBanco = 'TODAS' OR @CuentaBanco = '' OR CCB.NumeroCuenta = LTRIM(RTRIM(@CuentaBanco)))
